        ...
        <div class="container text-center">
            ...
            <div class="row h-full">
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    ...
                    <br>
                    <p class="lead text-white fs-20 hidden-sm-down"><span class="fw-400">Bahdcasts</span> is an awesome web development learning<br>
                        subscription based SaaS  application powered with Vuejs and <span class="mark-border">Laravel 5.5   </span>.</p>
